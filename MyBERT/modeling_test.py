...
import random
import re
from typing import TypeVar, Generic, List, Tuple, Dict, Any, Self, Optional
...
class BertModelTest(tf.test.TestCase):
    ...
    @classmethod
    def ids_tensor(cls, shape: List[int], vocab_size: int, rng: Optional[random.Random] = None, name: Optional[str] = None) -> tf.Tensor:
