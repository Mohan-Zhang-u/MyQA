...
def create_instances_from_document(
        all_documents: List[List[List[str]]], document_index: int, max_seq_length: int, short_seq_prob: float,
        masked_lm_prob: float, max_predictions_per_seq: int, vocab_words: List[str], rng: random.Random) -> List[TrainingInstance]:
...
def create_masked_lm_predictions(tokens: List[str], masked_lm_prob: float,
                                 max_predictions_per_seq: int, vocab_words: List[str], rng: random.Random) -> Tuple[List[str], List[int], List[str]]:
